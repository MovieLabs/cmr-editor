...
<xsl:stylesheet version="2.0" 
	...
	xmlns:mdcr="http://www.movielabs.com/schema/mdcr/v1.1" xmlns:md="http://www.movielabs.com/schema/md/v2.1/md">
	...
	<xsl:param name="mLabVersion"/>
		...
		<html xmlns="http://www.w3.org/1999/xhtml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:mdcr="http://www.movielabs.com/schema/mdcr/v1.1" xmlns:md="http://www.movielabs.com/schema/md/v2.1/md">
			<head>
				...
				<!--Converted using XSL version 2.0 (2017-a) -->
				<meta http-equiv="Content-Type" content="text/html;  charset=utf-8"/>
				<link rel="Shortcut Icon" href="/images/ml_icon.ico"/>
<!-- 				<link href="../../../../style/movielab2.css" rel="stylesheet" type="text/css"/>  -->
<!-- 				<link href="../../styles/CMRatings.css" rel="stylesheet" type="text/css"/>  -->
			<link href="../../../../style/movielab-2017.css" rel="stylesheet" type="text/css" />
			</head>
			<body>
			<xsl:comment>generated using transform 'WrappedSummary2017.xslt'(v6)</xsl:comment>
					...
					<tr>
						...
						<xsl:call-template name="leftSide" />
									...
									<td>
										...
										<table  id="summaryTable" border="1" cellpadding="0" cellspacing="0" summary="">
											<thead align="center"  >
												<th>Region</th>
												<th>Type</th>
												<th>Environ</th>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td>
										...
										<ul>
											<li>Please submit questions and comments to<br/>
												 <img src="../../../../ratings_email.gif" width="123" height="13" alt="ratings~At~movielabs(dot)com"/> 
											</li>
										</ul>
									</td>
								</tr>
					...
					<tr>
						<td class="footer">
							<div align="center">
								<hr width="100%" size="1"/>
								<p>
									<a href="../../../../AboutUs/contact.html">Contact Us</a> | <a href="../../../../proposal.html">Submit
                        a Technical Proposal </a> | <a href="../../../../Challenge/index.html">Technology
                        Open Challenge</a> | <a href="../../../../AboutUs/press.html">Press</a> | <a href="../../../../termsofuse.html">Terms
